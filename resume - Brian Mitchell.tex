...
{Articulate}
{Remote}
{\jobtitle[March 2025-Present]{Senior Software Engineer I}
\begin{itemize}
    \item[--] Worked on the Rise Media team to support and develop features for the Rise authoring and learning experiences.
\end{itemize}}
...
{\jobtitle[June 2022-January 2025]{Senior Software Engineer}
\begin{itemize}
...
\begin{itemize}
    ...
    \item[--] Led development and publishing for the Engineering Blog.
\end{itemize}

\jobtitle[November 2016-January 2018]{Software Engineer I}
\begin{itemize}
    \item[--] Led major refactoring and development for a customer analytics tool.
